-- Content to Action — Full Database Schema
...
-- Anonymous and authenticated users can read their own jobs
...
-- Service role handles updates (job processor)
...
create policy "Service role can insert artifacts"
  on public.analysis_artifacts for insert
  with check (true);
